...
$Referer_check_domain = "journey.webdeveloperkei.xyz";
...
<?php echo $errm; ?><br /><br /><input type="button" value=" Back" onClick="history.back()">
</div>
<?php }else{ ?>
<h3>Confirmation</h3>
<p align="center">以下の内容で間違いがなければ、「Send」ボタンを押してください。</p>
...
//確認画面無しの場合の表示、指定のページに移動する設定の場合、エラーチェックで問題が無ければ指定ページヘリダイレクト
	...
	if($empty_flag == 1){ ?>
<div align="center"><h4>入力にエラーがあります。下記をご確認の上「Back」ボタンにて修正をお願い致します。</h4><div style="color:red"><?php echo $errm; ?></div><br /><br /><input type="button" value="Back" onClick="history.back()"></div>
<?php 
